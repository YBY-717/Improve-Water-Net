...
3.将训练数据放入相应文件夹。目录结构data_UIEB文件夹下应该包含train和val（train文件夹应该包含Ground Truth图像gt_train、直方图均衡化图像input_ce_train、伽马校正图像input_gc_train、白平衡图像input_wb_train和原始图像input_train） <br>
